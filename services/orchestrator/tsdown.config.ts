...
export default defineConfig({
	...
	//
	// Solana's libraries are compiled in as well: only packages/solana may depend on them, so the
	// orchestrator reaches them through that package and never declares them itself.
	deps: {
		neverBundle: true,
