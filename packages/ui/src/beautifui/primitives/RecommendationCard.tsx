...
import { Button, type ButtonVariant } from "../atoms/Button.tsx";
import { EntityChip } from "../atoms/EntityChip.tsx";
import { ValuePill } from "../atoms/ValuePill.tsx";
			...
			>
				<div className="overflow-hidden">
					<div className="border-t border-line bg-surface px-2 py-2">
						<p className="px-1.5 pb-1 text-[11px] font-medium text-ink-3">{t.otherOptions}</p>
						{others.map(({ o, i }) => (
							<button
								key={o.key}
								type="button"
